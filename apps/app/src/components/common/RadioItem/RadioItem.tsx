...
const RadioItem = ({ id, title, name, control, value }: RadioItemProps) => {
  ...
  return (
    <label className="w-full flex items-center justify-start p-3 rounded-lg border border-input relative cursor-pointer">
      <input
        type="radio"
        {...field}
        name={name}
      ...
      <div className="flex items-start justify-start gap-3 w-full">
        <Image
          ...
          width={16}
          height={16}
          className="peer-checked:block hidden relative z-20 -mt-px"
        />
        <Image
          ...
          width={16}
          height={16}
          className="peer-checked:hidden block -mt-px"
        />
